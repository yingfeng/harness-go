...
func TestEngine_NodePanicRecovery(t *testing.T) {
	...
	sg.AddNode("normal", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val": "ok"}, nil
	})
...
func TestEngine_NodeErrorPropagation(t *testing.T) {
	...
	sg.AddNode("good", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val": "good"}, nil
	})
	sg.AddNode("failing", func(ctx context.Context, state interface{}) (interface{}, error) {
		return nil, fmt.Errorf("node failure")
	})
	sg.AddNode("never_reached", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val": "should_not_happen"}, nil
	})
...
func TestEngine_PartialNodeFailureInFanOut(t *testing.T) {
	...
	sg.AddNode("bad", func(ctx context.Context, state interface{}) (interface{}, error) {
...
func TestEngine_ContextCancellationMidExecution(t *testing.T) {
	...
	sg.AddNode("slow_start", func(ctx context.Context, state interface{}) (interface{}, error) {
		...
		return map[string]interface{}{"val": "slow_done"}, nil
	})
	sg.AddNode("never_run", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val": "should_not_reach"}, nil
	})
...
func TestEngine_MixedBSPAndDAG(t *testing.T) {
	t.Parallel()
	sg := graph.NewStateGraph(map[string]interface{}{"counter": 0, "merged": ""})
	sg.AddChannel("counter", channels.NewLastValue(0))
	...
	sg.AddNode("loop_body", func(ctx context.Context, state interface{}) (interface{}, error) {
		m := safeMap(state)
		c, _ := m["counter"].(int)
		m["counter"] = c + 1
		return m, nil
	...
	sg.AddNode("exit_loop", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{}, nil
	})
	sg.AddNode("fork_a", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{}, nil
	})
	sg.AddNode("fork_b", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{}, nil
	})
	sg.AddNode("dag_join", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"merged": "all_done"}, nil
	})
...
func TestEngine_ConditionalEdgesWithDAG(t *testing.T) {
	t.Parallel()
	sg := graph.NewStateGraph(map[string]interface{}{"route": "", "result": ""})
	...
	sg.AddNode("router", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"route": "alpha"}, nil
	})
	sg.AddNode("alpha", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"result": "alpha_done"}, nil
	})
	sg.AddNode("beta", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"result": "beta_done"}, nil
	})
...
func TestEngine_LargeFanOut100(t *testing.T) {
	t.Parallel()
	const n = 100
	sg := graph.NewStateGraph(map[string]interface{}{"aggregated": 0, "done": ""})
	sg.NodeTriggerMode = types.NodeTriggerAllPredecessor
	sg.AddChannel("aggregated", channels.NewBinaryOperatorAggregate(0, func(a, b interface{}) interface{} {
		return a.(int) + b.(int)
	}))
	sg.AddChannel("done", channels.NewLastValue(""))

	sg.AddNode("source", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"aggregated": 0}, nil
	})
	for i := 0; i < n; i++ {
		name := fmt.Sprintf("leaf%d", i)
		sg.AddNode(name, func(ctx context.Context, state interface{}) (interface{}, error) {
			return map[string]interface{}{"aggregated": 1}, nil
		})
	}
	sg.AddNode("collector", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"done": "collected"}, nil
	})
...
func TestEngine_InterruptAndLoop(t *testing.T) {
	t.Parallel()
	sg := graph.NewStateGraph(map[string]interface{}{"counter": 0, "value": ""})
	sg.AddChannel("counter", channels.NewLastValue(0))
	sg.AddChannel("value", channels.NewLastValue(""))
	...
	sg.AddNode("checkpoint", func(ctx context.Context, state interface{}) (interface{}, error) {
		m := safeMap(state)
		c, _ := m["counter"].(int)
		// Halt on counter == 2 to test interrupt
		if c == 2 {
			return nil, &errors.GraphInterrupt{Interrupts: []interface{}{"stopped at checkpoint node"}}
		}
		m["counter"] = c
	...
	result1, err1 := engine.RunSync(context.Background(), map[string]interface{}{})
	if err1 != nil {
...
func TestEngine_EmptyNodeExecution(t *testing.T) {
	...
	sg.AddNode("start", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val": "initial"}, nil
	})
	sg.AddNode("empty", func(ctx context.Context, state interface{}) (interface{}, error) {
		return nil, nil // engine must handle nil output gracefully
	})
	sg.AddNode("end", func(ctx context.Context, state interface{}) (interface{}, error) {
		m := safeMap(state)
		m["val"] = "final"
		return m, nil
	})
...
func TestEngine_NodeReuseConcurrentRun(t *testing.T) {
	...
	for i := 0; i < concurrency; i++ {
		...
		go func(id int) {
			...
			_, err := engine.RunSync(context.Background(), map[string]interface{}{"val": "start"})
			if err != nil {
				errs <- fmt.Errorf("engine %d: %w", id, err)
			}
		}(i)
...
func TestEngine_ExtremeConfigValues(t *testing.T) {
	...
	t.Run("recursion_limit_zero", func(t *testing.T) {
		...
		sg.AddChannel("val", channels.NewLastValue(""))
		sg.AddNode("a", func(ctx context.Context, state interface{}) (interface{}, error) {
			return map[string]interface{}{"val": "x"}, nil
		})
...
func TestEngine_MultipleEntryPoints(t *testing.T) {
	t.Parallel()
	sg := graph.NewStateGraph(map[string]interface{}{"val_a": "", "val_b": ""})
	sg.AddChannel("val_a", channels.NewLastValue(""))
	sg.AddChannel("val_b", channels.NewLastValue(""))

	sg.AddNode("entry_a", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val_a": "from_a"}, nil
	})
	sg.AddNode("entry_b", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val_b": "from_b"}, nil
	})
	sg.AddNode("join", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val_a": "joined"}, nil
	})
...
func TestEngine_NodeWithBothEdgeAndConditionalEdge(t *testing.T) {
	...
	sg.AddNode("start", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"counter": 0, "value": "start"}, nil
	})
	sg.AddNode("router", func(ctx context.Context, state interface{}) (interface{}, error) {
		m := safeMap(state)
		c, _ := m["counter"].(int)
...
func TestEngine_NodeTimeout(t *testing.T) {
	...
	sg.AddNode("quick", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"val": "quick"}, nil
	})
	sg.AddNode("slow", func(ctx context.Context, state interface{}) (interface{}, error) {
...
func TestEngine_MultipleFanInNodes(t *testing.T) {
	t.Parallel()
	sg := graph.NewStateGraph(map[string]interface{}{"a": 0, "b": 0, "result": ""})
	sg.NodeTriggerMode = types.NodeTriggerAllPredecessor
	sg.AddChannel("a", channels.NewBinaryOperatorAggregate(0, func(x, y interface{}) interface{} {
		return x.(int) + y.(int)
	}))
	sg.AddChannel("b", channels.NewBinaryOperatorAggregate(0, func(x, y interface{}) interface{} {
		return x.(int) + y.(int)
	}))
	sg.AddChannel("result", channels.NewLastValue(""))

	sg.AddNode("split", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"a": 0, "b": 0}, nil
	})
	sg.AddNode("x1", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"a": 1}, nil
	})
	sg.AddNode("x2", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"a": 2}, nil
	})
	sg.AddNode("y1", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"b": 10}, nil
	})
	sg.AddNode("y2", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"b": 20}, nil
	})
	sg.AddNode("join_a", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{}, nil
	})
	if n, ok := sg.GetNode("join_a"); ok {
		n.Triggers = []string{"a"}
	}
	sg.AddNode("join_b", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{}, nil
	})
	if n, ok := sg.GetNode("join_b"); ok {
		n.Triggers = []string{"b"}
	}
	sg.AddNode("final_join", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"result": "all_done"}, nil
	})
...
func TestEngine_OverwriteValue(t *testing.T) {
	...
	sg.AddNode("writer", func(ctx context.Context, state interface{}) (interface{}, error) {
		return map[string]interface{}{"value": types.NewOverwrite("overwritten")}, nil
	})
...
func TestEngine_TrivialEmptyGraph(t *testing.T) {
	...
	engine := NewEngine(sg, WithRecursionLimit(5))
	result, err := engine.RunSync(context.Background(), map[string]interface{}{"x": "hello"})
	if err != nil {
...
func TestEngine_PregelWithCustomChannels(t *testing.T) {
	t.Parallel()
	sg := graph.NewStateGraph(map[string]interface{}{"total": 0, "value": ""})
	...
	engine := NewEngine(sg, WithRecursionLimit(5))
	result, err := engine.RunSync(context.Background(), map[string]interface{}{"total": 10, "value": "init"})
	if err != nil {
		t.Fatalf("RunSync failed: %v", err)
	}
	if result == nil {
...
func TestEngine_SingleNodeGraph(t *testing.T) {
	...
	for _, mode := range []types.NodeTriggerMode{
		...
		t.Run(string(mode), func(t *testing.T) {
			...
			sg.AddChannel("val", channels.NewLastValue(""))
			sg.AddNode("only", func(ctx context.Context, state interface{}) (interface{}, error) {
				return map[string]interface{}{"val": "single"}, nil
			})
