...
func (m *callTrackingMiddleware) WrapToolInvoke(ctx context.Context, ep InvokableToolEndpoint, tc *ToolContext) (InvokableToolEndpoint, error) {
	return ep, nil
}
func (m *callTrackingMiddleware) WrapToolStream(ctx context.Context, ep StreamableToolEndpoint, tc *ToolContext) (StreamableToolEndpoint, error) {
	return ep, nil
}
func (m *callTrackingMiddleware) WrapEnhancedInvoke(ctx context.Context, ep EnhancedInvokableToolEndpoint, tc *ToolContext) (EnhancedInvokableToolEndpoint, error) {
	return ep, nil
}
