...
func ShellTool(workDir string) agentcore.Tool {
...
func StreamingShellTool(workDir string) agentcore.Tool {
	return agentcore.NewBaseTool(
		"streaming_shell",
...
// TaskCreateTool returns an agentcore.Tool for creating sub-tasks.
...
// TaskListTool returns an agentcore.Tool for listing all sub-tasks.
...
// TaskUpdateTool returns an agentcore.Tool for updating a sub-task's status.
func TaskUpdateTool(m *TaskManager) agentcore.Tool {
	return agentcore.NewBaseTool(
		"update_todo",
