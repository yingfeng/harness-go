...
import (
	...
	"github.com/infiniflow/ragflow/harness/agentcore/evals"
	"github.com/infiniflow/ragflow/harness/agentcore/prebuilt/coding"
...
func newCodingEval(workDir string, model agentcore.Model[*schema.Message], query string, scorers []evals.Scorer) evals.EvalCase {
