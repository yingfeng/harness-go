...
type EvalConfig struct {
	...
	LLMJudgeModel agentcore.Model[*schema.Message]
}
...
func LLMJudge(judgeModel agentcore.Model[*schema.Message], instruction string) Scorer {
	return func(ctx context.Context, r *EvalResult) error {
		text := lastAssistantText(r)
		if text == "" {
...
func judgeOutput(ctx context.Context, model agentcore.Model[*schema.Message], query, output, instruction string) error {
